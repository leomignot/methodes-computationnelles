...
## Lien cours
![](./img/qrcode.png){style="display:block; margin-left:auto; margin-right:auto;"}

---

## Contexte

- Multiplication des données (types et volume)
  - données et "digital traces"
  - nouveaux "terrains"

- Avancées informatiques et puissances de calcul
...
- Léo Mignot
- Ingénieur de recherche CNRS - CED
...
- Qui êtes vous ?
- Quel thème de recherche ? (même très vague)
- Déjà une expérience avec des langages de programmation ?
- Quelles sont vos attentes / Qu'est-ce qui vous intéresse dans ce cours ? (rien est une réponse valable)
- Qui sait que vous êtes ici ? (pensez aux données que vous générez)

<!--
Inspiré de : https://bookdown.org/paul/computational_social_science/who-are-you.html
-->
...
- Des sciences sociales avec des ordinateurs (-ish)
  - méthodes / outils informatiques
  - grand volume données (ou nouvelles données)
  - des questions de sciences sociales
- Intersection entre champs sciences sociales et "datascience" et "computer science"
  - Interdisciplinaire ? -> meeeeehhhhhhh
- Renouvellement des objets de recherche et des méthodes
- Types de recherches/questions

---

## Enjeux

- Outillage / compétences
- Frontières professionnelles (sciences sociales vs informatique, etc.)
- Dépendance aux pourvoyeurs de données (compagnies, RS, etc.)
- Risque guider questions de recherche par disponibilité des données, etc.
